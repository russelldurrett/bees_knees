...
#	sample_fastqs = [f for f in sample_fastqs]
	...
	# The second identifier in the third part of the string sequence is the file type and should be changed appropiately
	# The third identifier in the third part of the string sequence is the read type and should be chnaged appropiately
